...
lm_order=1 #language model order (n_gram)
...
# script for checking prepared data - here: for data/train directory
# utils/fix_data_dir.sh data/train          
# tool for data proper sorting if needed - here: for data/train directory
...
steps/decode.sh --config conf/decode.config --nj $nj --cmd "$decode_cmd" exp/tril/graph data/test exp/tril/decode 
